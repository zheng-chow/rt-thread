...
#ifndef __DRV_ETH_H7_H__
#define __DRV_ETH_H7_H__
...
#define PHY_AUTO_NEGOTIATION_RESTART_MASK   (1<<9)
...
#define PHY_Status_REG              0x05U
#define PHY_10M_MASK                (1<<2)
#define PHY_100M_MASK               (7<<7)
#define PHY_FULL_DUPLEX_MASK        (5<<6)
