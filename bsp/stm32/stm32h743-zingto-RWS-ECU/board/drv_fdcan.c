...
{
	{CAN1MBaud,     4,8,15,4},
	{CAN800kBaud,   4,8,20,4},
	{CAN500kBaud,   8,8,15,4},
	{CAN250kBaud,   8,8,35,4},
	{CAN125kBaud,   16,8,35,4},
	{CAN100kBaud,   16,8,44,5},
	{CAN50kBaud,    32,8,44,5},
	{CAN20kBaud,    80,8,44,5},
	{CAN10kBaud,    160,8,44,5}
};
/*
...
static rt_err_t _inline_can_config(struct rt_can_device *can, struct can_configure *cfg)
{
	...
	HAL_FDCAN_ConfigGlobalFilter(&pdrv_can->fdcanHandle,FDCAN_REJECT, FDCAN_REJECT, FDCAN_REJECT, FDCAN_REJECT);
...
static rt_err_t _inline_can_filter_config(_stm32_fdcan_t *pdrv_can,struct rt_can_filter_config *puser_can_filter_config)
{
	...
	{
		pdrv_can->FilterConfig.FilterIndex = tmp_i32IndexCount;//puser_can_filter_config->items[tmp_i32IndexCount].hdr;
		...
		if(puser_can_filter_config->items[tmp_i32IndexCount].ide == RT_CAN_EXTID)
		{
			...
			pdrv_can->FilterConfig.FilterID2 = puser_can_filter_config->items[tmp_i32IndexCount].mask & 0x1fffffff;
		}
		else
		{
			pdrv_can->FilterConfig.IdType = FDCAN_STANDARD_ID;
			pdrv_can->FilterConfig.FilterID2 = puser_can_filter_config->items[tmp_i32IndexCount].mask & 0x7ff;
		}
...
static rt_err_t _inline_can_control(struct rt_can_device *can, int cmd, void *arg)
{
	...
	case RT_DEVICE_CTRL_CLR_INT:
		...
		else if (argval == RT_DEVICE_FLAG_INT_TX)
		{
			...
			//HAL_FDCAN_DeactivateNotification(&pdrv_can->fdcanHandle,  FDCAN_IT_TX_ABORT_COMPLETE);
	...
	case RT_DEVICE_CTRL_SET_INT:
		...
		else if (argval == RT_DEVICE_FLAG_INT_TX)
		{
			...
			HAL_FDCAN_ActivateNotification(&pdrv_can->fdcanHandle,  FDCAN_IT_TX_COMPLETE, FDCAN_TX_BUFFER3);
			HAL_FDCAN_ActivateNotification(&pdrv_can->fdcanHandle,  FDCAN_IT_TX_COMPLETE, FDCAN_TX_BUFFER4);
			HAL_FDCAN_ActivateNotification(&pdrv_can->fdcanHandle,  FDCAN_IT_TX_COMPLETE, FDCAN_TX_BUFFER5);
			HAL_FDCAN_ActivateNotification(&pdrv_can->fdcanHandle,  FDCAN_IT_TX_COMPLETE, FDCAN_TX_BUFFER6);
			HAL_FDCAN_ActivateNotification(&pdrv_can->fdcanHandle,  FDCAN_IT_TX_COMPLETE, FDCAN_TX_BUFFER7);
			HAL_FDCAN_ActivateNotification(&pdrv_can->fdcanHandle,  FDCAN_IT_TX_COMPLETE, FDCAN_TX_BUFFER8);
			HAL_FDCAN_ActivateNotification(&pdrv_can->fdcanHandle,  FDCAN_IT_TX_COMPLETE, FDCAN_TX_BUFFER9);
			HAL_FDCAN_ActivateNotification(&pdrv_can->fdcanHandle,  FDCAN_IT_TX_COMPLETE, FDCAN_TX_BUFFER10);
			HAL_FDCAN_ActivateNotification(&pdrv_can->fdcanHandle,  FDCAN_IT_TX_COMPLETE, FDCAN_TX_BUFFER11);
			HAL_FDCAN_ActivateNotification(&pdrv_can->fdcanHandle,  FDCAN_IT_TX_COMPLETE, FDCAN_TX_BUFFER12);
			HAL_FDCAN_ActivateNotification(&pdrv_can->fdcanHandle,  FDCAN_IT_TX_COMPLETE, FDCAN_TX_BUFFER13);
			HAL_FDCAN_ActivateNotification(&pdrv_can->fdcanHandle,  FDCAN_IT_TX_COMPLETE, FDCAN_TX_BUFFER14);
			HAL_FDCAN_ActivateNotification(&pdrv_can->fdcanHandle,  FDCAN_IT_TX_COMPLETE, FDCAN_TX_BUFFER15);
			HAL_FDCAN_ActivateNotification(&pdrv_can->fdcanHandle,  FDCAN_IT_TX_COMPLETE, FDCAN_TX_BUFFER16);
			HAL_FDCAN_ActivateNotification(&pdrv_can->fdcanHandle,  FDCAN_IT_TX_COMPLETE, FDCAN_TX_BUFFER17);
			HAL_FDCAN_ActivateNotification(&pdrv_can->fdcanHandle,  FDCAN_IT_TX_COMPLETE, FDCAN_TX_BUFFER18);
			HAL_FDCAN_ActivateNotification(&pdrv_can->fdcanHandle,  FDCAN_IT_TX_COMPLETE, FDCAN_TX_BUFFER19);
			HAL_FDCAN_ActivateNotification(&pdrv_can->fdcanHandle,  FDCAN_IT_TX_COMPLETE, FDCAN_TX_BUFFER20);
			HAL_FDCAN_ActivateNotification(&pdrv_can->fdcanHandle,  FDCAN_IT_TX_COMPLETE, FDCAN_TX_BUFFER21);
			HAL_FDCAN_ActivateNotification(&pdrv_can->fdcanHandle,  FDCAN_IT_TX_COMPLETE, FDCAN_TX_BUFFER22);
			HAL_FDCAN_ActivateNotification(&pdrv_can->fdcanHandle,  FDCAN_IT_TX_COMPLETE, FDCAN_TX_BUFFER23);
			HAL_FDCAN_ActivateNotification(&pdrv_can->fdcanHandle,  FDCAN_IT_TX_COMPLETE, FDCAN_TX_BUFFER24);
			HAL_FDCAN_ActivateNotification(&pdrv_can->fdcanHandle,  FDCAN_IT_TX_COMPLETE, FDCAN_TX_BUFFER25);
			HAL_FDCAN_ActivateNotification(&pdrv_can->fdcanHandle,  FDCAN_IT_TX_COMPLETE, FDCAN_TX_BUFFER26);
			HAL_FDCAN_ActivateNotification(&pdrv_can->fdcanHandle,  FDCAN_IT_TX_COMPLETE, FDCAN_TX_BUFFER27);
			HAL_FDCAN_ActivateNotification(&pdrv_can->fdcanHandle,  FDCAN_IT_TX_COMPLETE, FDCAN_TX_BUFFER28);
			HAL_FDCAN_ActivateNotification(&pdrv_can->fdcanHandle,  FDCAN_IT_TX_COMPLETE, FDCAN_TX_BUFFER29);
			HAL_FDCAN_ActivateNotification(&pdrv_can->fdcanHandle,  FDCAN_IT_TX_COMPLETE, FDCAN_TX_BUFFER30);
			HAL_FDCAN_ActivateNotification(&pdrv_can->fdcanHandle,  FDCAN_IT_TX_COMPLETE, FDCAN_TX_BUFFER31);*/		
			
			//HAL_FDCAN_ActivateNotification(&pdrv_can->fdcanHandle,  FDCAN_IT_TX_ABORT_COMPLETE, FDCAN_TX_BUFFER0);
...
void HAL_FDCAN_TxBufferCompleteCallback(FDCAN_HandleTypeDef *hfdcan, uint32_t BufferIndexes)
{
...
#ifdef BSP_USING_FDCAN1
		//can1
		for (rt_uint8_t box_num = 0; box_num < 32; box_num++){
			if (BufferIndexes & (1 << box_num))
				rt_hw_can_isr(&st_DrvCan1.device, RT_CAN_EVENT_TX_DONE | (box_num << 8));
	...
	else
	{
		...
		for (rt_uint8_t box_num = 0; box_num < 32; box_num++){
			if (BufferIndexes & (1 << box_num))
				rt_hw_can_isr(&st_DrvCan2.device, RT_CAN_EVENT_TX_DONE | (box_num << 8));
				//rt_hw_can_isr(&st_DrvCan1.device, RT_CAN_EVENT_TX_DONE | ((BufferIndexes-1) << 8));
		}
#endif
	}
...
{/*
	if(hfdcan->Instance == FDCAN1){
#ifdef BSP_USING_FDCAN1
		for (rt_uint8_t box_num = 0; box_num < 32; box_num++){
			if (BufferIndexes & (1UL << box_num)){
				rt_hw_can_isr(&st_DrvCan1.device, RT_CAN_EVENT_TX_FAIL | (box_num << 8));
			}
		}
#endif
	}
		...
		for (rt_uint8_t box_num = 0; box_num < 32; box_num++){
			if (BufferIndexes & (1UL << box_num)){
				rt_hw_can_isr(&st_DrvCan2.device, RT_CAN_EVENT_TX_FAIL | (box_num << 8));
			}
		}
#endif	
...
void HAL_FDCAN_ErrorCallback(FDCAN_HandleTypeDef *hfdcan)
{
	...
	if(hfdcan->Instance == FDCAN1)
	{
		...
		else
		{
			...
			if (st_DrvCan1.device.status.snderrcnt < ((tmp_u32Errcount)&0x000000ff)){
				uint32_t TransmittedBuffers = hfdcan->Instance->TXBCF;
				TransmittedBuffers &= hfdcan->Instance->TXBTIE;
				if (TransmittedBuffers == 0) TransmittedBuffers = 1;
				for (rt_uint8_t box_num = 0; box_num < 32; box_num++){
					if (TransmittedBuffers & (1UL << box_num)){
						rt_hw_can_isr(&st_DrvCan1.device, RT_CAN_EVENT_TX_FAIL | (box_num << 8));
						//rt_hw_can_isr(&st_DrvCan1.device, RT_CAN_EVENT_TX_FAIL | ((TransmittedBuffers-1) << 8));
					}
				}
			}
			else{
				rt_hw_can_isr(&st_DrvCan1.device, RT_CAN_EVENT_TX_FAIL | (0 << 8));
			}
	...
	else
	{
		...
		else
		{
			...
			if (st_DrvCan1.device.status.snderrcnt < ((tmp_u32Errcount)&0x000000ff)){
				uint32_t TransmittedBuffers = hfdcan->Instance->TXBTO;
				TransmittedBuffers &= hfdcan->Instance->TXBTIE;
				for (rt_uint8_t box_num = 0; box_num < 32; box_num++){
					if (TransmittedBuffers & (1 << box_num))
						rt_hw_can_isr(&st_DrvCan2.device, RT_CAN_EVENT_TX_FAIL | (box_num << 8));
						//rt_hw_can_isr(&st_DrvCan2.device, RT_CAN_EVENT_TX_FAIL | ((TransmittedBuffers-1) << 8));
				}	
			}
